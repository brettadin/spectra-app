...
The [`get_cutouts`](../api/astroquery.mast.HapcutClass.html#astroquery.mast.HapcutClass.get_cutouts "astroquery.mast.HapcutClass.get_cutouts") function takes a coordinate and cutout size (in pixels or
