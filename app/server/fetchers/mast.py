...
_CALSPEC_TARGETS: Tuple[CalSpecTarget, ...] = (
    ...
    CalSpecTarget(
        canonical_name="BD+17 4708",
        prefix="bd17d4708",
        spectral_type="sdF8",
        distance_pc=131.33,
        instrument_label="HST/STIS",
        description="Metal-poor F subdwarf serving as a long-term CALSPEC anchor.",
        aliases=(
            "bd+17 4708",
            "bd 17 4708",
            "bd174708",
        ...
        preferred_modes=("stis", "stisnic"),
        fallback_modes=("mod",),
    ),
    CalSpecTarget(
        canonical_name="GD 71",
        prefix="gd71",
        spectral_type="DA1.5",
        distance_pc=51.11,
        instrument_label="HST/STIS",
        description="Hot DA white dwarf providing ultraviolet flux stability.",
        aliases=(
            "gd71",
            "gd 71",
            "wd0549+158",
    ...
    CalSpecTarget(
        canonical_name="GD 153",
        prefix="gd153",
        spectral_type="DA1.2",
        distance_pc=68.53,
        instrument_label="HST/STIS",
        description="Primary CALSPEC DA white dwarf calibrator.",
        aliases=(
            "gd153",
            "gd 153",
            "wd1254+223",
    ...
    CalSpecTarget(
        canonical_name="G191-B2B",
        prefix="g191b2b",
        spectral_type="DA0.8",
        distance_pc=52.49,
        instrument_label="HST/STIS",
        description="Hot DA white dwarf that underpins the CALSPEC UV scale.",
        aliases=(
            "g191-b2b",
            "g191 b2b",
            "wd0501+527",
    ...
    CalSpecTarget(
        canonical_name="HD 93521",
        prefix="hd93521",
        spectral_type="O9.5 IIInn",
        distance_pc=1276.0,
        instrument_label="HST/STIS",
        description="High-latitude O star for far-UV sensitivity checks.",
        aliases=(
            "hd 93521",
            "hr 4242",
            "hip 52727",
    ...
    CalSpecTarget(
        canonical_name="Feige 110",
        prefix="feige110",
        spectral_type="sdO",
        distance_pc=270.85,
        instrument_label="HST/STIS",
        description="Blue subdwarf extending CALSPEC into the far ultraviolet.",
        aliases=(
            "feige110",
            "feige 110",
            "wd2321-477",
